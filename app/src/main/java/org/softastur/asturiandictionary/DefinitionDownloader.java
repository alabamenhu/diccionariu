...
/**
 * Created by Matthew Stephen Stuckwisch on 5/7/15.
 */
public class DefinitionDownloader extends AsyncTask<String, Void, String>  {

    private int mTag;
    private long mTime;
    private DefinitionDownloaderCallback mCallback;
    private Map<String,String> post_param = new HashMap<String,String>();
    private static final String baseURL = "http://asturianu.elahorcado.net/search_json.php?search=";

    public interface DefinitionDownloaderCallback {
    ...
    public void setCallback(DefinitionDownloaderCallback callback) {
        mCallback = callback;
    }
    ...
    protected String doInBackground(String... searchTerms) {
        ...
        try {
            url = new URL(baseURL + searchTerms[0]);
